...
namespace ETicaretAPI.Persistence.Services
{
    public class AuthService : IAuthService
    {
        ...
        public AuthService(IHttpClientFactory httpClientFactory,
            ...
            UserManager<Domain.Entites.Identity.AppUser> userManager,
        ...
        public async Task<Token> FacebookLoginAsync(string authToken, int accessTokenLifeTime)
        {
            ...
            if (validation?.Data.IsValid != null)
            {
                ...
                Domain.Entites.Identity.AppUser? user = await _userManager.FindByLoginAsync(info.LoginProvider,
                    info.ProviderKey);
        ...
        public async Task<Token> LoginAsyn(string usernameOrEmail, string password, int accessTokenLifeTime)
        {
        ...
        public async Task<Token> RefreshTokenLoginAsyn(string refreshToken)
        {
